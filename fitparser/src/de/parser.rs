...
pub enum BaseType {
    // This could be merged with the autogenerated FitBaseType?
    /// Enum type
    Enum = 0x00,
    /// i8 type
    SInt8 = 0x01,
    ...
    /// f64 type
    Float64 = 0x89,
    /// i8 type with special undefined
    UInt8z = 0x0A,
    /// u16 type with special undefined
    UInt16z = 0x8B,
    /// u32 type with special undefined
    UInt32z = 0x8C,
    /// byte
    Byte = 0x0D,
    /// i64 type
    ...
    /// u64 type
    UInt64 = 0x8F,
    /// u64 type with special undefined
    UInt64z = 0x90,
}

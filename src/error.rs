...
pub enum ErrorKind {
    ...
    Custom(String),
    /// Serde has many deserialization methods, not all are applicable to FIT files.
    NotSupported(String),
...
impl fmt::Display for ErrorKind {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            ErrorKind::NotSupported(ref method) => write!(
                fmt,
                "FIT doesn't support serde::Deserializer::{} method",
                method
            ),
